...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ wait cheyy pulle 😂⌛',
				success: '✔️ okhda kutta ✔️',
				error: {
					stick: '❌ 👿 ❌',
					Iv: '❌ Nadakkoola mwone  ❌'
				},
				only: {
					group: '❌ evde admin thendi! ❌',
					ownerG: '❌ evde admin thendi! ❌',
					ownerB: '❌ evde admin thendi! ❌',
					admin: '❌ mone nadakkoola {ADMIN}! ❌',
					Badmin: '❌ ! ❌'
				}
			}
				...
				case 'listadmins':
					...
					break
                                ...
                                case 'leave':
                                        ...
                                        break
				case 'toimg':
					if (!isQuotedSticker) return reply('❌ error❌')
					reply(mess.wait)
